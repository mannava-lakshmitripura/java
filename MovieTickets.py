...
if __name__ == "__main__":
    ...
    movietheater.customer("1", "Tripura")
    movietheater.customer("2", "kamal")
    movietheater.customer("3", "Manoj")
    movietheater.customer("4", "sushma")
    movietheater.customer("5", "pooji")
    movietheater.customer("6", "Nagasai")
    movietheater.customer("7", "Kiran")
    movietheater.customer("8", "karthik")
